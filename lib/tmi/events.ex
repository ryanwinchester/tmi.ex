defmodule TMI.Events.Action do
...
defmodule TMI.Events.Connecting do
  defstruct [:channel, :tags]
end
...
defmodule TMI.Events.Emoteonly do
  defstruct [:channel, :tags]
end
...
defmodule TMI.Events.Hosting do
  defstruct [:channel, :tags]
end

defmodule TMI.Events.Join do
  defstruct [:channel, :tags]
end
...
defmodule TMI.Events.Raw_message do
  defstruct [:channel, :tags]
end
...
defmodule TMI.Events.Slowmode do
  defstruct [:channel, :tags]
end

defmodule TMI.Events.Subgift do
  defstruct [:channel, :message, :tags]
end
...
defmodule TMI.Events.Unhost do
  defstruct [:channel, :tags]
end

defmodule TMI.Events.Unmod do
  defstruct [:channel, :tags]
end
...
defmodule TMI.Events.Whisper do
  defstruct [:channel, :tags]
end
